...
function TravelerRequest() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("Dados do pedido a serem enviados:", requestData);

            const response = await createTravelRequest(requestData);
            const requestId = response.data.requestId;
            
            setTravelRequestId(requestId);
            setMessage("Pedido de viagem enviado com sucesso! Aguarde a aprovação.");
        ...
        switch (requestStatusEnum) {
            ...
            case StatusEnum.Submitted:
                return {
                    ...
                    progress: 66,
                    description: "Seu pedido foi enviado e está aguardando aprovação"
                };
            default:
                return {
                    text: "Em Preenchimento",
                    ...
                    {requestStatusEnum === StatusEnum.Draft ? (
                        <form onSubmit={handleSubmit}>
                            <div className="row g-3">
                                <div className="col-12">
                                    <label className="form-label small fw-bold">Projeto *</label>
                                    <ComboBox
                                        fetchUrl="/Project"
                        ...
                        <div className="alert alert-success">
                            ...
                            <div className="d-flex justify-content-between mt-3">
                                ...
                                <div className="text-muted small">
                                    Seu pedido está agora aguardando aprovação
                                </div>
                            </div>
                        </div>
                    ) : null}
